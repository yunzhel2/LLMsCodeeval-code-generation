...
def parse_arguments():
    ...
    # parser.add_argument('--result_save_name', default='code_smell_eval_codet5p.jsonl',
    #                     choices=['code_review_eval_codet5p.jsonl', 'code_smell_eval_codet5p.jsonl',
    #                              'code_test_data_codet5p.jsonl'], type=str)
    # parser.add_argument('--log_file_name', default='code_smell_eval_codet5p.log',
    #                     choices=['code_review_eval_codet5p.log', 'code_smell_eval_codet5p.log',
    #                              'code_test_data_codet5p.log'], type=str)
...
def add_code_translation(example):
    ...
    user_message = f"""Please translate following source code from {source_lang} to  {target_lang}. 
         Source code\n: {source_code}
        """
    prompt = f"""
...
#
#     # supported languages:
#     lang_cluster = ['C++', 'Java', 'Python', 'C', 'C#', 'Ruby', 'delphi', 'Go',add_program_synthesis
#                     'Javascript', 'Kotlin', 'PHP', 'd', 'perl', 'Rust']
#     source_lang = example['lang_cluster']
#     target_lang = example['target_lang_cluster']
#     prob_uid = example['src_uid']
...
if __name__ == '__main__':
    ...
    main()
    # python scripts/eval_codet5p.py
